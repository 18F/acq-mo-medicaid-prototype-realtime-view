...
import { DCN as DCNActions } from '../../actions';
...
spenddown.propTypes = {
  ...
  spenddown: React.PropTypes.shape(Object.assign(
...
function mapStateToProps(state) {
  ...
  return state.spenddown || defaultSpenddown;
}

function mapDispatchToProps(dispatch) {
  return {
    lookupDCN(dcn) {
      dispatch(DCNActions.checkDCN(dcn));
    }
  };
}
